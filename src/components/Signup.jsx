...
function Signup() {
  ...
  const submitInfo = async (event) => {
    ...
    const birthdayAttr = new CognitoUserAttribute({
      Name: "birthdate",
      Value: birthday,
    });
    ...
    const fullUserData = { firstName, lastName, birthday, phoneNumber };

    UserPool.signUp(
      email,
      password,
      [firstNameAttr, lastNameAttr, birthdayAttr, phoneNumberAttr],
      null,
      (err, data) => {
        if (err) {
          console.error(err);
